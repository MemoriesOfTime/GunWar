        ...
        if (args.length < 2) {
            ...
            if (!this.gunWar.getRoomConfigs().containsKey(args[1])) {
                ...
                if (level != null) {
                    ...
                    sender.sendMessage(this.language.translateString("admin_createRoom_success", args[1]));
                    ...
                    sender.sendMessage(this.language.translateString("world_doesNotExist", args[1]));
                }
            }else {
                sender.sendMessage(this.language.translateString("admin_createRoom_exist"));
            }
        }
        return true;
    }
