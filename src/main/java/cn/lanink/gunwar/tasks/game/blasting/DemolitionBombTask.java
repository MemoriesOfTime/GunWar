...
public class DemolitionBombTask extends PluginTask<GunWar> {
    ...
    public void cancel() {
        if (this.demolitionProgress >= MAX_DEMOLITION_PROGRESS) {
            Tools.sendTitle(this.room, "", this.owner.getLanguageOld().game_blasting_bombHasBeenDismantled);
            ...
            this.player.sendTitle("", this.owner.getLanguageOld().game_blasting_cancelDemolition);
